...
class Slug {
	...
	//----------------------Code to create URL friendly slugs from Google---------------------------------//
   ...
   public static function makeSlugs($string, $maxlen=100)  ///THIS IS THE FUNCTION I
   {
      $newStringTab=array();
   ...
   //----------------------Code to create URL friendly slugs from Google ends ---------------------------------//
}