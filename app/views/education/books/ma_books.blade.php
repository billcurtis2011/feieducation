        ...
        <div class="container sub-header-content">
            <div class="row">
                <div class="col-md-12 sub-header-text-content">
                    <h1 class="main-headeing"><span class="animated fadeInDown">{{Lang::get('MA_program.heading_title')}}</span></h1>
                    <p class="lead boxed-subheading-semiblue animated fadeInDown">
                        {{Lang::get('MA_program.heading_subtitle')}}
                    </p>
                </div>
            </div><!-- End row -->
        </div><!-- End container -->
            ...
            <div class="row page-inner-section">
                <div class="col-md-8">
                    ...
                    <div class="books-list-well icon-">
                        <h3 class="advisement-heading"><em>Young and Proctor</em>Kinn’s The Medical Assistant: An Applied Learning Approach, 11th Edition & Workbook.</h3>
                        <h4>
                            <ul class="books-features-list">
                                <li>ISBN #:  <strong>9781416054368</strong></li>
                    ...
                    <div class="books-list-well icon-">
                        <h3 class="advisement-heading"><em>Applegate</em>The Anatomy & Physiology Learning System, 4th Edition Text and Study Guide package</h3>
                        <h4>
                            <ul class="books-features-list">
