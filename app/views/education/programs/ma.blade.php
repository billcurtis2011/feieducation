    ...
    <section id="main_content">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{Lang::get('MA_program.heading_title')}}</li>
            </ol>

            <div class="row page-inner-section">
                <div class="col-md-8">
                    {{Lang::get('MA_program.program_summary_desc')}}
                    
                    <?php /* 
                    <div class="course-classes-table"> 
                        <div class="panel panel-info filterable">
                            <div class="panel-heading">
                                <h3 class="panel-title">{{Lang::get('MA_program.program_table_title')}}</h3>
                            </div>
                           {{Lang::get('MA_program.program_req_table')}} 
                        </div><!-- End filterable -->
                    </div>
                        */ ?>
                    <br/>
                    {{Lang::get('MA_program.program_objectives')}}
                    <br/>
                    {{Lang::get('MA_program.career_outlook')}}
                </div>
