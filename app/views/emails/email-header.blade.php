...
#headline p { color: #616161; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; font-size: 36px; text-align: center; margin-top:0px; margin-bottom:10px; }
#headline p a { color: #616161; text-decoration: none; }
.article-title { font-size: 18px; line-height:24px; color: #15253B; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; }
...
.footer-content-left { font-size: 12px; line-height: 15px; color: #666; margin-top: 0px; margin-bottom: 15px; }
.footer-content-left a { color: #d9fffd; font-weight: bold; text-decoration: none; }
.footer-content-right { font-size: 11px; line-height: 16px; color: #666; margin-top: 0px; margin-bottom: 15px; }
.footer-content-right a { color: #d9fffd; font-weight: bold; text-decoration: none; }
#footer { background-color: #f1f1f1; color: #666; }
...
<tr>
    <td align="center" bgcolor="#fafafa">
        ...
        <tbody>
        <tr>
            <td class="w640" width="640" height="10">
            </td>
        </tr>
        <!-- #HEADER 
                ================================================== -->
        <tr>
            <td id="header" class="w640" width="640" align="center" bgcolor="#005b7f">
                ...
                <tr>
                    ...
                    <td class="w580" width="580">
                        <div align="center" id="headline">
                            <p>
                                <img style="display: block; width: 100px; margin: 0 auto;" src="http://{{Request::server('SERVER_NAME')}}/assets/img/fei-logo.png" width="100">
                            </p>
                        </div>
                    </td>
                    <td class="w30" width="30">
