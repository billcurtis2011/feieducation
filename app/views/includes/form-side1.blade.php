            ...
            <li class="col-md-12 no-padding">
                <div class="feiSelect">
                    <select id="cd-dropdown" class="cd-select">
                        ...
                        <option value="Medical Assistant">Ayudante de Medicina</option>
                        <option value="Medical Billing and Coding">Facturación Médica y codificación</option>
                        <option value="Patient Care Technician">Técnico en Atención Paciente</option>
                        <option value="Pharmacy Technician">Técnico de farmacia</option>
                        <option value="Medical Administrator">Administrador Médico</option>
                        <option value="Massage Therapy">Terapia de Masaje</option>
                        <option value="Business Management">Administración de Empresas</option>
                    </select>
                </div>
            </li>
        </ul>
