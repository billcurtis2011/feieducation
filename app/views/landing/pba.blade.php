@section('content')
<section id="sub-header" class="landing-page-heading pba-landing">
    <div class="header-overlay-imgthief"></div>
    <div class="container sub-header-content">
        <div class="row">
            <div class="col-md-10 col-md-push-1 sub-header-text-content">
                 {{Lang::get('PBA_program.page_main_title_section')}}
            </div>
        </div>
        <!-- End row -->
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-md-push-1">
                 {{Lang::get('PBA_program.career_outlook_section')}}
            </div>
        </div>
        <!-- End row -->
        <!-- <div class="row">
            <div class="col-md-10 col-md-push-1">
                 {{Lang::get('PBA_program.partners_list')}}
...
<section class="program2nd-sec">
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-push-1">
                 {{Lang::get('PBA_program.about_program_section')}}
            </div>
        </div>
    </div>
</section>
...
<section class="program3nd-sec">
    <div class="container">
        <div class="row">
             {{Lang::get('PBA_program.why_choose_fei')}}
        </div>
    </div>
</section>
