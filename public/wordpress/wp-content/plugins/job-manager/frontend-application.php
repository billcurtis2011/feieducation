...
function jobman_app_field_input_html( $id, $field, $data, $mandatory = '' ) {
	...
	switch( $field['type'] ) {
		case 'text':
			return "<input type='text' class='form-control' name='jobman-field-$id' value='$data' />";
		case 'radio':
			$values = explode( "\n", $data );
		...
		case 'select':
			...
			$content .= "$mandatory <select class='form-control' name='jobman-field-{$id}[]'>";
			foreach( $values as $key => $value ) {
			...
			return $content;
		case 'textarea':
			return "$mandatory <textarea class='form-control' name='jobman-field-$id'>{$field['data']}</textarea>";
		case 'date':
			return "$mandatory <input type='text' class='datepicker form-control' name='jobman-field-$id' value='$data' />";
		case 'file':
			return "$mandatory <input type='file' class='form-control' name='jobman-field-$id' />";
		case 'geoloc':
			$jobman_geoloc = true;
